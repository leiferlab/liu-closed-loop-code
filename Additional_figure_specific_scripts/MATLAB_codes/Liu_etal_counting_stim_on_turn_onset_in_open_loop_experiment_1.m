%%%% This code is used in the analysis for generating data for table 1 in the 
%%%% specific case where I want to count the number of stim on turn onsets in
%%%% open loop assays.
...
for folder_index = [1:length(folders)]
    ...
    for track_index = 1:length(current_tracks)
        ...
        %%%then filter valid stims further and impose taht they fall in this
