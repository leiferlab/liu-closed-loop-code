function Tracks = find_stereotyped_behaviors(Tracks, L, xx, velocity_based_behavior_edges, parameters)
    ...
    duration_cutoff = parameters.StereotypedBehaviorMinTime * parameters.SampleRate;
...
%             stereotyped_behavior_ends; stereotyped_behavior_duration]';
        ...
        Tracks(track_index).VelocityBehavior = discretize_given_edges(Tracks(track_index).Velocity', velocity_based_behavior_edges);
    end
