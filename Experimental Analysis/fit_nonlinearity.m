function [non_linearity_fit, non_linearities, bin_centers, errors] = fit_nonlinearity(filtered_signal_given_behavior_histogram, filtered_signal_histogram, bin_edges, parameters)
